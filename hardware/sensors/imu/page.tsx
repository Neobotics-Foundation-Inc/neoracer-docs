...
export const metadata: Metadata = {
  ...
  description:
    '9-axis: the ICM-45686 6-axis IMU plus a magnetometer, integrated on the OSCORE board. Topics, frames, and the rc.physics Python API.',
};
      ...
      <MouseFollowGlow>
        <section style={{ position: 'relative', paddingBottom: 32, paddingTop: 24 }}>
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              Two parts on one board: the ICM-45686 (a TDK InvenSense 6-axis IMU,
              3-axis accelerometer and 3-axis gyroscope) and a 3-axis
              magnetometer, nine axes between them. They report how the car is
              accelerating, how fast it is turning, and where magnetic north sits,
              all in the imu_link frame at 100 Hz.
            </p>
            <div style={{ display: 'flex', gap: 8, marginTop: 16, flexWrap: 'wrap' }}>
              <ChromeBadge variant="red">ICM-45686 + magnetometer</ChromeBadge>
...
print(mag)     # magnetic field vector`}
      ...
      <ScrollReveal>
        <section style={{ paddingBottom: 32 }}>
          ...
          >
            {[
              ['IMU', 'ICM-45686 (6-axis) + magnetometer'],
              ['Accelerometer', 'm/s^2'],
              ['Gyroscope', 'rad/s'],
              ['Magnetometer', 'teslas'],
              ['Rate', '100 Hz'],
