            ...
            items={[
              {
                ...
                photos: [{ src: '/images/JupyterLabs/jupyter_opening_page.png', alt: 'JupyterLab open in a browser at 192.168.10.100:8888, with the file browser highlighted on the left' }],
              },
              {
                ...
                photos: [{ src: '/images/JupyterLabs/jupyter_access_async.png', alt: 'The file browser path neoracer-os/labs/tests with the test files listed' }],
              },
              {
                text: <>Double-click{' '}
                  <code style={{ fontFamily: NB.monoFont }}>test_async_core_real.ipynb</code>{' '}
                  to open it.</>,
                photos: [{ src: '/images/JupyterLabs/jupyter_open_async.png', alt: 'The Async Core Test notebook open in JupyterLab' }],
              },
              {
                text: <>Run the notebook from the toolbar at the top of the tab.
                  ...
                  cells run in order.</>,
                photos: [{ src: '/images/JupyterLabs/jupyter_run_cells.png', alt: 'The notebook toolbar with the run-cell button boxed in red and the restart-and-run-all button boxed in blue' }],
              },
              {
                ...
                photos: [{ src: '/images/JupyterLabs/jupyter_typical_cell.png', alt: 'A typical test cell with its title and explanation, code block, and printed output' }],
              },
            ]}
          />
        </section>
